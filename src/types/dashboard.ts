...
export const WidgetSchema = z.object({
  id: z.string(), // uuid
  type: z.enum(['chart', 'portfolio', 'orderForm', 'transactionHistory', 'custom', 'orderbook', 'trades', 'deals', 'tradesV2', 'dataProviderSettings', 'dataProviderDemo', 'dataProviderSetup', 'dataProviderDebug', 'notificationTest', 'debugUserData', 'debugCCXTCache', 'exchanges', 'markets', 'pairs', 'userBalances']),
